...
export const vi = {
  ...
  "marginalia": {
    ...
    "facts": [
      ...
      "Hàng chục nghìn nhà thiết kế trên toàn cầu phụ thuộc vào các khuôn khổ và tài nguyên của tôi.",
  ...
  "vita": {
    ...
    "paragraphs": [
      ...
      "Cha mẹ tôi đều từng làm việc tại Macy's trước khi tôi ra đời - phần lớn gu thẩm mỹ và thiên hướng của tôi là được thừa hưởng từ họ. Tuổi thơ là sự xây dựng và sáng tạo: LEGO, phim hoạt hình tĩnh vật, sách vở, viết lách và thời trang. Qua những phương tiện ấy, tôi đã khám phá ra tình yêu của mình với việc kể chuyện, và đưa mọi thứ từ 0 đến 1 (từ trí tưởng tượng đến hiện thực). Tôi cũng đã khám phá từ rất sớm sự say mê căn bản của mình với mọi hình thức biểu đạt của con người, và sứ mệnh lan tỏa nó dưới mọi hình thức.",
