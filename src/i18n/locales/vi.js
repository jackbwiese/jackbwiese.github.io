// auto-generated translation for vi
export const vi = {
  "arsenal": {
    "eyebrow": "§ V · Kho Vũ Khí",
    "heading": "Tham gia.",
    "tiles": [
      {
        "title": "ONTHEBIAS",
      ...
      },
      {
        ...
        "years": "2025 -",
        "role": "Thành Viên",
        "body": "Sáng kiến từ thiện và văn hóa có trụ sở tại Paris dưới sự bảo trợ của Cartier, quy tụ một thế hệ mới các nhà bảo trợ và người kiến tạo."
      },
      {
        "title": "The Residency",
        "years": "2026",
        "role": "Nhà Sáng Lập Khóa",
        "body": "Chương trình tại San Francisco hỗ trợ các nhà sáng lập và những cá nhân xuất chúng. Được Sam Altman hậu thuẫn. Tỷ lệ chấp nhận ~0.5%."
      },
      {
        "title": "HRMTG",
        "years": "2021 - 2024",
        "role": "Nhà Sáng Lập",
        "body": "Một dự án đam mê. Historical Reinterpretations Made Through Garments. Nhãn hiệu streetwear đã được vận chuyển tới hơn 12 quốc gia. Đối tác chiến dịch với Free Arts NYC và Palestine Children's Relief Fund (PCRF). Thiết bị sản xuất được tặng vào ngày tốt nghiệp cho chương trình nghệ thuật của trường cũ của người sáng lập."
      },
      {
      ...
      },
      {
        ...
        "years": "2017 -",
        "role": "Thương Hiệu + Marketing + Thiết Kế",
        "body": "Bản sắc thương hiệu, marketing và thiết kế cho cả nhà sáng lập lẫn các thương hiệu hiện hữu, xây dựng những công ty sản phẩm vật lý đáng để xây dựng."
      }
    ]
  },
  "brandStrip": {
    "eyebrow": "Những thương hiệu tôi đã góp sức.",
    "subEyebrow": "(qua thiết kế và sáng tạo sản phẩm)",
  ...
  "cabinet": {
    "collections": [
      {
        "era": "Thế kỷ 15 - 18",
        "note": "Flemish, Aubusson, Gobelins. Thần thoại, săn bắn, ngụ ngôn. Đang hình thành một bộ sưu tập.",
        "title": "Thảm trang trí cổ"
      },
      {
        "era": "Thế kỷ 14 - 18",
        "note": "Vũ khí châu Âu thời kỳ hiệp sĩ và đầu cận đại. Kiếm rapier, mũ giáp, bộ giáp từng phần. Đang hình thành một bộ sưu tập.",
        "title": "Vũ khí và áo giáp lịch sử"
      },
      {
        "era": "Thế kỷ 15 - 19",
        "note": "Mercator, Blaeu, Ortelius. Bản đồ của đế quốc, cuộc thám hiểm, những vùng đất đã mất. Đang hình thành một bộ sưu tập.",
        "title": "Bản đồ cổ"
      },
      {
        "era": "Thế kỷ 14 - hiện đại",
        "note": "Những tác phẩm đánh dấu những khoảnh khắc khi trang phục trở thành ngôn ngữ. Đang hình thành một bộ sưu tập.",
        "title": "Trang phục lịch sử và có ý nghĩa"
      }
    ],
    "eyebrow": "§ VII · Cabinet de Curiosités",
    "formingALabel": "đang hình thành một bộ sưu tập",
    "heading": "Bốn bộ sưu tập cá nhân, đang được tập hợp dần dần."
  },
  "contact": {
    "companyLabel": "Công ty",
    "cta": "Đặt một cuộc gặp →",
  ...
  "footer": {
    "knightTitle": "HIỆP SĨ CỦA ĐƯỜNG CHÉO ĐỎ THẪM"
  },
  "hero": {
    "est": "EST. 2001",
    "scroll": "CUỘN",
    "sigSuffix": "Mục đích cuộc đời tôi (raison d'être): nhân rộng biểu đạt sáng tạo trong thế giới vật chất và đặt nền móng cho một cuộc phục hưng nhân loại toàn cầu.",
  ...
  "manifesto": {
    "eyebrow": "§ I · Tuyên Ngôn",
    "ledePrefix": "Một",
    "ledeSuffix": ": người kể chuyện kết nối vạn vật lại với nhau.",
    "purposeAccent1": "lan tỏa sự sáng tạo và sự chiêm nghiệm nội tâm",
  ...
  "marginalia": {
    ...
    "facts": [
      ...
      "Tôi đã ảnh hưởng đến phong cách của Emma Chamberlain trước khi cô ấy trở thành cái tên quen thuộc trong từng gia đình.",
      "Tôi đã làm việc tại hơn 46 - và còn nữa - quốc gia.",
      "Tôi là nhà thiết kế yêu thích của nhà thiết kế yêu thích của bạn.",
      "Các tài liệu của tôi được sử dụng tại các trường và chương trình thời trang khắp thế giới như một chuẩn mực mẫu mực.",
      "Hàng chục nghìn nhà thiết kế trên toàn cầu phụ thuộc vào các khuôn khổ kỹ thuật và tài nguyên của tôi.",
      "Tôi tự học một cách quyết liệt.",
      "Tôi đã tạo ra hơn 20M lượt hiển thị trên mạng xã hội.",
      "Tôi đã xây dựng cuộc đời và sự nghiệp của mình để làm cây cầu giữa giấc mơ và hiện thực vật lý cho người khác - ở quy mô lớn. Đó là điều khiến tôi viên mãn.",
      ...
      "Cuốn sách yêu thích của tôi là Don Quijote de La Mancha."
    ]
  },
  "meta": {
    "title": "Jack (B.) Wiese",
  ...
  "nav": {
    "arsenal": "Kho Vũ Khí",
    "cabinet": "Tủ Trưng Bày",
    "contact": "Liên Hệ",
    "manifesto": "Tuyên Ngôn",
    "marginalia": "Marginalia",
    "obsessions": "Niềm Đam Mê",
    "vita": "Vita",
    "worldview": "Thế Giới Quan"
  },
  "obsessions": {
    "eyebrow": "§ VI · Niềm Đam Mê",
    "grewUpForget": "từ",
    "heading": "Tôi đọc gì, tôi yêu gì, tôi suy nghĩ ra sao.",
    "history": [
      "Thời Đại Buồm (1500-1850)",
      "Cướp biển vùng Caribbean và Thái Bình Dương",
      "Châu Âu Trung Cổ và các Hiệp Sĩ Đoàn",
      "Hy Lạp và La Mã Cổ Đại",
      "Cách mạng 1776 · 1789 · 1848 · 1917",
      "Habsburg · Bourbon · Romanov",
      "Florence thời Phục Hưng"
    ],
    "historyHeader": "Lịch Sử",
    "historyLead": "Bất kỳ thời kỳ chuyển dịch hệ hình sâu sắc nào:",
    "inOtherFormsLabel": "Dưới những hình thức khác",
    "languagesGoalPrefix": "Mục tiêu cả đời:",
    "languagesGoalPunct": ".",
    "languagesGoalWord": "mười hai",
    "languagesHeader": "Ngôn Ngữ",
    "literature": [
      "Cervantes - Don Quixote",
      "Homer - Iliad & Odyssey",
      "Tolstoy - War and Peace",
      "Shakespeare - những bi kịch hậu kỳ",
    ...
    "literatureHeader": "Văn Chương",
    "literatureLead": "Một vài tác phẩm yêu thích:",
    "makingBody": "Điêu khắc, hội họa, khiêu vũ, chạy bộ, học ngôn ngữ, du lịch: một vài hoạt động yêu thích của tôi!",
    "makingHeader": "Sáng tạo, ngoài bàn làm việc",
    "paintingCaption": "Vị thánh bảo trợ của việc dám mơ những giấc mơ lớn và hành động táo bạo hướng tới những giấc mơ ấy.",
    "paintingCaptionLead2": "Dar al través (đánh chìm tàu):",
    "paintingCaption2": "Khi cam kết trở nên không thể đảo ngược.",
    "paintingCaptionLead3": "Theo van Doesburg:",
    "paintingCaption3": "Nơi bắt nguồn cảm hứng cho hình vuông đặt chéo. Định hướng độc đáo chống lại chính thống.",
    "paintingCaptionLead": "Don Quijote:",
    "poemReaderBylinePrefix": "bởi Jack Wiese",
    "poemReaderBylineSuffix": "phần",
    "poemReaderCollapse": "↑ Thu gọn",
    "poemReaderEnd": "- hết loạt thơ -",
    "poemReaderToggleClose": "Đóng loạt thơ",
    "poemReaderToggleOpen": "Đọc trọn loạt thơ",
    "soundBody": "Trong một khoảng thời gian ngắn, tôi đã giữ một cuốn nhật ký âm thanh dưới bút danh Pensive Bouts. Những giờ yên lặng, được ghi âm thành tiếng. Một dấu ngoặc đơn.",
    "soundKind": "Âm thanh",
    "soundTitle": "Pensive Bouts",
    "writingsBody": "Một bản chứng thực gửi đến một độc giả không đang theo dõi.",
    "writingsKind": "Tác phẩm viết",
  ...
  "triptych": {
    "captions": [
      {
        "body": "",
        "lead": "Quý ông phong nhã suốt đời."
      },
      {
        "body": "Cuối cùng chúng tôi đã mất nó :(",
        "lead": "Trang trại gia đình cũ."
      },
      {
        "body": "Vẫn đứa trẻ ấy. Sân khấu lớn hơn.",
        "lead": "Hôm nay."
      }
    ],
    "numerals": [
